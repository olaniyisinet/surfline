/*1494088480,,JIT Construction: v3005125,en_US*/
...
try {
        ...
        for (var i = 0; i < sandboxWhitelist.length; i++) {
            ...
            with(this) {
                ...
                __d("JSSDKXDConfig", [], {
                    ...
                    "XdBundleUrl": "\/connect\/xd_arbiter\/r\/87XNE1PC38r.js?version=42",
                    "Flash": {
                ...
                __d('URISchemes', ['createObjectFrom'], (function a(b, c, d, e, f, g, h) {
                    var i = h(['blob', 'cmms', 'fb', 'fbatwork', 'fb-ama', 'fb-messenger', 'fb-page-messages', 'fb-pma', 'fbcf', 'fbconnect', 'fbmobilehome', 'fbrpc', 'file', 'ftp', 'http', 'https', 'mailto', 'ms-app', 'intent', 'itms', 'itms-apps', 'itms-services', 'market', 'svn+ssh', 'fbstaging', 'tel', 'sms', 'pebblejs', 'sftp', 'whatsapp', 'moments', 'fblite', 'chrome-extension', 'webcal', 'fb124024574287414', 'fb124024574287414rc', 'fb124024574287414master', 'fb1576585912599779', 'fb929757330408142', 'designpack', 'fbapi20130214', 'fb1196383223757595', 'tbauth']),
                        j = {
                ...
                __d('sdk.AppEvents', ['Assert', 'ApiClient', 'sdk.Event', 'sdk.Impressions', 'sdk.Model', 'sdk.Runtime', 'FBAppEvents', 'sdk.Auth'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    ...
                    function aa(na, oa, pa, qa) {
                        ...
                        k.impression({
                            api_key: na,
                            payload: ES('JSON', 'stringify', false, ra)
                        });
                    }

                    function ba(na, oa, pa, qa) {
                        var ra = o.getAuthResponse(),
                            sa = ra && ra.accessToken ? ra.accessToken : null;
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"3005125","namespace":"FB","message":"' + e.message + '"}}');
}